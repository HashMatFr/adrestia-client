export const useProfileStore = defineStore('profile', {
  ...
  actions: {
    setMatcher(payload) {
      this.matcher.matcherId = payload.matcherId ?? this.matcher.matcherId
      this.matcher.minAge = payload.minAge ?? this.matcher.minAge
      this.matcher.maxAge = payload.maxAge ?? this.matcher.maxAge
      this.matcher.relationshipGoal =
        payload.relationshipGoal ?? this.matcher.relationshipGoal
      this.matcher.childrenSituation =
        payload.childrenSituation ?? this.matcher.childrenSituation
      this.matcher.alcoholConsumption =
        payload.alcoholConsumption ?? this.matcher.alcoholConsumption
      this.matcher.smokingSituation =
        payload.smokingSituation ?? this.matcher.smokingSituation
      this.matcher.ethnicity = payload.ethnicity ?? this.matcher.ethnicity
    ...
    setDetail(payload) {
      this.detail.detailId = payload.detailId ?? this.detail.detailId
      this.detail.age = payload.age ?? this.detail.age
      this.detail.size = payload.size ?? this.detail.size
      this.detail.relationshipGoal =
        payload.relationshipGoal ?? this.detail.relationshipGoal
      this.detail.childrenSituation =
        payload.childrenSituation ?? this.detail.childrenSituation
      this.detail.alcoholConsumption =
        payload.alcoholConsumption ?? this.detail.alcoholConsumption
      this.detail.smokingSituation =
        payload.smokingSituation ?? this.detail.smokingSituation
      this.detail.ethnicity = payload.ethnicity ?? this.detail.ethnicity
      this.detail.politicalView =
        payload.politicalView ?? this.detail.politicalView
      this.detail.fitness = payload.fitness ?? this.detail.fitness
      this.detail.religion = payload.religion ?? this.detail.religion
      this.detail.sex = payload.sex ?? this.detail.sex
      this.detail.orientation = payload.orientation ?? this.detail.orientation
      this.detail.city = payload.city ?? this.detail.city
    },
    setCoordinates(payload) {
      this.detail.latitude = payload.latitude ?? this.detail.latitude
      this.detail.longitude = payload.longitude ?? this.detail.longitude
    },
    setInfos(payload) {
      this.city = payload.city ?? this.city
      this.job = payload.job ?? this.job
